...
class PresentFutureWeatherModel extends PresentFutureWeather{
  ...
  PresentFutureWeatherModel.fromJson(dynamic json) {
    lat = json['lat'];
    lon = json['lon'];
    ...
    if (json['daily'] != null) {
      ...
      json['daily'].forEach((v) {
        daily?.add(DailyModel.fromJson(v));
      });
    }
  }
...
class DailyModel extends Daily{
  ...
  DailyModel.fromJson(dynamic json) {
    dt = json['dt'];
    ...
    feelsLike = json['feels_like'] != null ? FeelsLikeModel.fromJson(json['feels_like']) : null;
...
class FeelsLikeModel extends FeelsLike {
  FeelsLikeModel({
    ...
    double? night,
    double? eve,
    double? morn,}):super(day:day,
    night:night,
    eve:eve,
    morn:morn,
  );

  FeelsLikeModel.fromJson(dynamic json) {
    day = json['day'];
    night = json['night'];
    eve = json['eve'];
    morn = json['morn'];
...
FeelsLikeModel copyWith({  double? day,
  double? night,
  double? eve,
  double? morn,
}) => FeelsLikeModel(  day: day ?? this.day,
...
TempModel copyWith({  double? day,
  double? min,
  double? max,
  double? night,
  double? eve,
  double? morn,
}) => TempModel(  day: day ?? this.day,
  min: min ?? this.min,
  max: max ?? this.max,
  night: night ?? this.night,
  eve: eve ?? this.eve,
...
class HourlyModel extends Hourly {
  ...
  HourlyModel.fromJson(dynamic json) {
    dt = json['dt'];
    temp = json['temp'];
