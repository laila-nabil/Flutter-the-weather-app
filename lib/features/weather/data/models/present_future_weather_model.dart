...
class PresentFutureWeatherModel extends PresentFutureWeather {
  ...
  factory PresentFutureWeatherModel.fromJson(Map<String, dynamic> json){
    return PresentFutureWeatherModel(
      ...
      current: json["current"] == null ? null : _CurrentModel.fromJson(json["current"]),
      hourly: json["hourly"] == null ? [] : List<_CurrentModel>.from(json["hourly"]!.map((x) => _CurrentModel.fromJson(x))),
      daily: json["daily"] == null ? [] : List<_DailyModel>.from(json["daily"]!.map((x) => _DailyModel.fromJson(x))),
    );
  }
...
class _CurrentModel extends Current {
  ...
  factory _CurrentModel.fromJson(Map<String, dynamic> json){
    return _CurrentModel(
      ...
      weather: json["weather"] == null ? [] : List<_WeatherModel>.from(json["weather"]!.map((x) => _WeatherModel.fromJson(x))),
...
class _DailyModel extends Daily {
  ...
  factory _DailyModel.fromJson(Map<String, dynamic> json){
    return _DailyModel(
      ...
      feelsLike: json["feels_like"] == null ? null : FeelsLikeModel.fromJson(json["feels_like"]),
      pressure: json["pressure"],
      humidity: json["humidity"],
      dewPoint: json["dew_point"],
      windSpeed: json["wind_speed"],
