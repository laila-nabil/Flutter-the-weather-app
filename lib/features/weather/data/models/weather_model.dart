...
HourlyEntity mapHourlyListsEntityToHourlyEntity(
  ...
  return HourlyEntity(
    ...
    uv_index: hourlyListsEntity?.uv_index.tryElementAt(index),
    winddirection_10m: hourlyListsEntity?.winddirection_10m.tryElementAt(index),
    windspeed_10m: hourlyListsEntity?.windspeed_10m.tryElementAt(index),
    is_day: hourlyListsEntity?.is_day.tryElementAt(index),
  );
}
...
class HourlyUnitsModel extends HourlyUnitsEntity {
  ...
  factory HourlyUnitsModel.fromJson(dynamic json) {
    return HourlyUnitsModel(
      ...
      winddirection_10m : json['winddirection_10m'],
...
class CurrentWeatherModel extends CurrentWeatherEntity {
  CurrentWeatherModel({
    ...
    weatherCode: weathercode,time: time,isDay: isDay == 1
  );
