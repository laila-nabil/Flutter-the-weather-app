...
class WeatherTimelineModel extends WeatherTimeline {
  ...
  factory WeatherTimelineModel.fromJson(dynamic json) {
    List<DayModel>? days;
    if (json['days'] != null) {
      days = [];
      json['days'].forEach((v) {
...
class HoursModel extends Hours {
  ...
  HoursModel copyWith({ String? datetime,
    int? datetimeEpoch,
    double? temp,
    double? feelslike,
    double? humidity,
    ...
    String? source,
      ...
      HoursModel(datetime: datetime ?? this.datetime,
