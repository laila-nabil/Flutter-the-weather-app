...
class WeatherTimelineModel {
  ...
  WeatherTimelineModel.fromJson(dynamic json) {
  ...
  double? tzoffset;
  List<DaysModel>? days;
WeatherTimelineModel copyWith({  int? queryCost,
  double? latitude,
  double? longitude,
  String? resolvedAddress,
  String? address,
  ...
  double? tzoffset,
  List<DaysModel>? days,
}) => WeatherTimelineModel(  queryCost: queryCost ?? this.queryCost,
