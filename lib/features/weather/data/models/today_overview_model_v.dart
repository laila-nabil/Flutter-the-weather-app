...
class TodayOverviewModelV extends TodayOverviewV{
  TodayOverviewModelV({
    int? queryCost,
    double? latitude,
    double? longitude,
    ...
    double? tzoffset,
    DayModel? day,
    CurrentConditionsV? currentConditions,}):super(
    latitude: latitude,
    longitude: longitude,
    timezone: timezone,
    day: day,
  ...
  TodayOverviewModelV.fromJson(dynamic json) {
    ...
    currentConditions = json['currentConditions'] != null ? CurrentConditionsModelV.fromJson(json['currentConditions']) : null;
  }
...
class CurrentConditionsModelV extends CurrentConditionsV {
  CurrentConditionsModelV({
    String? datetime,
    int? datetimeEpoch,
    double? temp,
    double? feelslike,
  ...
  CurrentConditionsModelV.fromJson(dynamic json) {
  ...
  CurrentConditionsModelV copyWith({  String? datetime,
  int? datetimeEpoch,
  double? temp,
  double? feelslike,
  double? humidity,
  ...
  int? sunsetEpoch,
  double? moonphase,
}) => CurrentConditionsModelV(  datetime: datetime ?? this.datetime,
