...
import '../../data/models/day_weather_model_v.dart';
...
class WeatherTimelineModelV extends WeatherTimelineV {
  WeatherTimelineModelV({
    int? queryCost,
    double? latitude,
    double? longitude,
  ...
  factory WeatherTimelineModelV.fromJson(dynamic json) {
    List<DayModel>? days;
    if (json['days'] != null) {
      days = [];
      json['days'].forEach((v) {
  ...
  Map<String, dynamic> toJson() {
    List<Map<String, dynamic>> daysToJson = [];
    days?.forEach((element) {
      DayModel _element = DayModel(
        ...
        solarenergy:   element.solarenergy,
        snowdepth:   element.snowdepth,
        snow:   element.snow,
        ...
        feelslikemax: element.feelslikemax,
        feelslikemin:element.feelslikemin,
        precip: element.precip,
        precipcover: element.precipcover,
        severerisk: element.severerisk,
        tempmax: element.tempmax,
        tempmin: element.tempmin,
      );
      daysToJson.add(_element.toJson());
    });
    return {
      "queryCost": queryCost,
      "latitude": latitude,
...
class HoursModelV extends HoursV {
  HoursModelV({
    String? datetime,
    int? datetimeEpoch,
    double? temp,
  ...
  HoursModelV.fromJson(dynamic json) {
  ...
  HoursModelV copyWith({ String? datetime,
    int? datetimeEpoch,
    double? temp,
    double? feelslike,
    double? humidity,
    ...
    String? source,
      ...
      HoursModelV(datetime: datetime ?? this.datetime,
