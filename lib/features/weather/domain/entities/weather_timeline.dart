...
class WeatherTimelineV extends Equatable{
  WeatherTimelineV({
      this.queryCost, 
      this.latitude, 
      this.longitude, 
...
class HoursV extends Equatable{
  HoursV({
      this.datetime, 
      this.datetimeEpoch, 
      this.temp, 
  ...
  String? source;
HoursV copyWith({  String? datetime,
  int? datetimeEpoch,
  double? temp,
  double? feelslike,
  double? humidity,
  ...
  List<String>? stations,
  String? source,
}) => HoursV(  datetime: datetime ?? this.datetime,
