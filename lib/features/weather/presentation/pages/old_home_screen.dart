...
//
//   @override
//   _OldMyHomePageState createState() => _OldMyHomePageState();
// }
//
// class _OldMyHomePageState extends State<OldMyHomePage> {
//   var todayWeather = {};
...
//                         items: [WeatherToday(weatherToday: weatherBloc.currentWeather!,
//                             weatherTodayNotDetailed: weatherBloc
//                                 .presentFutureWeather
//                             !.elementAt(0)), CompareWeather()],
...
//                       child: Container(),
//                     ),
//                     Expanded(flex: 6, child: WeatherToday(weatherToday: weatherBloc.currentWeather!,
//                         weatherTodayNotDetailed: weatherBloc
//                             .presentFutureWeather
//                         !.elementAt(0))),
//                     Expanded(
...
//         ? Row(
//             children: [
//               SizedBox.expand(child: WeatherToday(weatherToday: weatherBloc.currentWeather!,
//                   weatherTodayNotDetailed: weatherBloc
//                       .presentFutureWeather
//                   !.elementAt(0))),
//               SizedBox.expand(
